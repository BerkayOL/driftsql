...
class PendingFileCleanupTable extends Table
    with TableInfo<PendingFileCleanupTable, PendingFileCleanupTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  PendingFileCleanupTable(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  PendingFileCleanupTableData map(
  ...
  @override
  PendingFileCleanupTable createAlias(String alias) {
    return PendingFileCleanupTable(attachedDatabase, alias);
  }
...
class PendingFileCleanupTableData extends DataClass
    implements Insertable<PendingFileCleanupTableData> {
  final int id;
  ...
  PendingFileCleanupTableCompanion toCompanion(bool nullToAbsent) {
    return PendingFileCleanupTableCompanion(
      id: Value(id),
  ...
  PendingFileCleanupTableData copyWith({
    int? id,
    String? filePath,
    int? createdAt,
  }) => PendingFileCleanupTableData(
    id: id ?? this.id,
    filePath: filePath ?? this.filePath,
    createdAt: createdAt ?? this.createdAt,
  );
  PendingFileCleanupTableData copyWithCompanion(
    PendingFileCleanupTableCompanion data,
  ) {
    return PendingFileCleanupTableData(
      id: data.id.present ? data.id.value : this.id,
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PendingFileCleanupTableData &&
          other.id == this.id &&
...
class PendingFileCleanupTableCompanion
    extends UpdateCompanion<PendingFileCleanupTableData> {
  final Value<int> id;
  ...
  static Insertable<PendingFileCleanupTableData> custom({
    Expression<int>? id,
  ...
  PendingFileCleanupTableCompanion copyWith({
    Value<int>? id,
...
class DatabaseAtV8 extends GeneratedDatabase {
  ...
  late final PendingFileCleanupTable pendingFileCleanupTable =
      PendingFileCleanupTable(this);
